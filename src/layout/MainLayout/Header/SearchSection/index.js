...
const useStyles = makeStyles((theme) => ({
    ...
    closeIcon: {
        ...
        display: 'flex',
        color: theme.palette.getContrastText(theme.palette.background.default)[100],
    },
    inputRoot: {
        color: 'inherit',
    },
    ...
    searchControl: {
        borderColor: theme.palette.getContrastText(theme.palette.background.default)[100],
        width: '434px',
        marginLeft: '16px',
        paddingRight: '8px',
        paddingLeft: '16px',
