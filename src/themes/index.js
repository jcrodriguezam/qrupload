...
export function theme(customization) {
    ...
    let menuHover = customization.menuHover || value.menuHover;
    let primary = customization.primary || value.primary;
        ...
        overrides: {
            ...
            MuiListItem: {
                root: {
                    ...
                    paddingBottom: '12px',
                    '&$selected': {
                        color: customization.navType === 'dark' ? menuHover : primary,
                        backgroundColor: customization.navType !== 'dark' ? menuHover : primary,
                        '&:hover': {
                            backgroundColor: customization.navType !== 'dark' ? menuHover : primary,
                        },
